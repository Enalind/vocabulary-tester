...
function getOptions(passedOptions) {
  var mergedOptions = Object.keys(defaultOptions).reduce(function (acc, key) {
    return Object.assign(acc, _defineProperty$1({}, key, passedOptions[key] !== undefined ? passedOptions[key] : defaultOptions[key]));
  }, {});
  return mergedOptions;
}

var colorToVec4 = function colorToVec4(color) {
...
function shaders(_ref) {
  var gl = _ref.gl,
      options = _ref.options; // Utility to fail loudly on shader compilation failure
...
function geometry(_ref) {
  var gl = _ref.gl,
      program = _ref.program; // Set up 4 vertices, which we'll draw as a rectangle
  // via 2 triangles
  //
  //   A---C
  //   |  /|
...
var simulateMovement = function simulateMovement(_ref2) {
  var metaballs = _ref2.metaballs,
      options = _ref2.options; // don't move last interactive cursor metaball
...
function initInteractive(_ref) {
  ...
  if (interactive && !["window", "canvas"].includes(interactive)) {
    throw new Error("options.interactive must be one of \"false\", \"'window'\", or \"'canvas'\". Provided \"".concat(interactive, "\" (").concat(_typeof$1(interactive), ")."));
  }
...
function (_Component) {
  ...
  console.log(_Component)
  _inherits(Metaballs, _Component);
  ...
  function Metaballs() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Metaballs)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this), "ref", React__default.createRef());

    return _this;
  }

  _createClass(Metaballs, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this$splitProps = this.splitProps(),
          options = _this$splitProps.options;
    ...
    key: "splitProps",
    value: function splitProps() {
      var _this$props = this.props,
          numMetaballs = _this$props.numMetaballs,
          minRadius = _this$props.minRadius,
          maxRadius = _this$props.maxRadius,
          speed = _this$props.speed,
          colorFrom = _this$props.colorFrom,
          colorTo = _this$props.colorTo,
          backgroundColorFrom = _this$props.backgroundColorFrom,
          backgroundColorTo = _this$props.backgroundColorTo,
          interactive = _this$props.interactive,
          useDevicePixelRatio = _this$props.useDevicePixelRatio,
          canvasProps = _objectWithoutProperties(_this$props, ["numMetaballs", "minRadius", "maxRadius", "speed", "colorFrom", "colorTo", "backgroundColorFrom", "backgroundColorTo", "interactive", "useDevicePixelRatio"]);
    ...
    value: function render() {
      var _this$splitProps2 = this.splitProps(),
          canvasProps = _this$splitProps2.canvasProps;

      return React__default.createElement("canvas", _extends({}, canvasProps, {
        ref: this.ref
      }));
    }
  }]);
...
_defineProperty(Metaballs, "propTypes", {
  ...
  interactive: propTypes.oneOfType([propTypes.bool, propTypes.oneOf(['window', 'canvas'])]),
